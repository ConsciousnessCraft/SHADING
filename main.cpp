...
//-----------------------------------------
{
    ...
    char filename0[] = "skybox/posx.ppm";
    char filename1[] = "skybox/negx.ppm";
    char filename2[] = "skybox/posy.ppm";
    char filename3[] = "skybox/negy.ppm";
    char filename4[] = "skybox/posz.ppm";
    char filename5[] = "skybox/negz.ppm";
...
void clavier(unsigned char touche, int x, int y)
{
    ...
    case 'M': /*toon shader */
        ...
        glutPostRedisplay();
        break;
    case 'n': /* envirenment map*/
        silouette = 0.0;
        shadType = 2.0;
        glutPostRedisplay();
        break;
    case 'N': /* envirenment map + toon shader*/
        silouette = 0.0;
        shadType = 3.0;
        glutPostRedisplay();
        break;
    case 'k': /* envirenment map + gooch shader*/
        silouette = 0.0;
        shadType = 4.0;
        glutPostRedisplay();
        break;
